;*************************************************************************************
;resistencia de pullup interna de los ports al conectar el pulsador
;
...
;
;*************************************************************************************	
;.include "m328def.inc"   ;Incluye los nombres de los registros específicos del microcontrolador Atmega328 y sus direcciones
...
main_loop:
;Espero un flanco descendente
flanco_des_ON:
	sbic	PUL_PORT_IN_1, PUL_PIN_ON
	rjmp	flanco_des_ON
	rcall	debounce_time
	sbic	PUL_PORT_IN_1, PUL_PIN_ON  ;si tengo flanco bajo salto a parpadear
	rjmp	flanco_des_ON
...
flanco_des_OFF:
	sbic	PUL_PORT_IN_2, PUL_PIN_OFF
	rjmp	parpadear
	rcall	debounce_time
	sbic	PUL_PORT_IN_2, PUL_PIN_OFF
	rjmp	parpadear
...
;*****rutina que parpadea el led con cierto delay******************
...
; Se habilito resistencia de pull up donde tengo pulsador los pines donde tengo pulsador
;
;Entrada: pulsador			
;Salida: leds					
...
configure_ports:
    ...
    cbi     LED_PORT,2   ;   lo pongo en cero 
ret
...
;*************************************************************************************
; Retardo de 50ms debounce (Calculado con un cristal de 1MHz, para otro valor 
